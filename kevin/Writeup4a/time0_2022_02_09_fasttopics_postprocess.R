...
pred_mat <- multiomicCCA:::.mult_vec_mat(rowSums(as.matrix(mat)), topic_res$L %*% t(topic_res$F))
sum((mat - pred_mat)^2)
sum((mat)^2)
1-(sum((mat - pred_mat)^2)/sum((mat)^2))
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup4a/2022-02-09_fasttopics_magnitudes.png"),
