...
for(treatment in treatment_vec){
  ...
  ggplot2::ggsave(filename = paste0("~/project/Multiome_fate/out/figures/Writeup8/Writeup8_", 
                                    treatment, "-from-day-", day_early, "_umap.png"),
  ...
  png(paste0("~/project/Multiome_fate/out/figures/Writeup8/Writeup8_",
             treatment, "-from-day-", day_early, "_train-test-curve.png"),
  ...
  ggplot2::ggsave(filename = paste0("~/project/Multiome_fate/out/figures/Writeup8/Writeup8_",
                                    treatment, "-from-day-", day_early, "_lineage-growthpotential-violinplot.png"),
  ...
  ggplot2::ggsave(filename = paste0("~/project/Multiome_fate/out/figures/Writeup8/Writeup8_",
                                    treatment, "-from-day-", day_early, "_imputation-ridge_umap.png"),
                  p1, device = "png", width = 5, height = 5, units = "in")
