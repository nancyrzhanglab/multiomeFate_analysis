...
rownames(svd_features) <- rownames(cell_features)
...
svd_coefficient_vec[1:5] <- seq(0.1, 0.05, length.out = 5)
...
png(filename = paste0("~/project/Multiome_fate/out/figures/Writeup9b/Writeup9b_alldata-cocl2_saver_simulation_variance2growth.png"),
...
save(fit_res_pca, final_fit_pca, simulation_res_pca,
     ...
     file = "~/project/Multiome_fate/out/kevin/Writeup9b/Writeup9b_day10-COCL2_saver_simulation_variance2growth.RData")
