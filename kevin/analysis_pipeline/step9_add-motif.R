...
load("../../../../out/kevin/analysis_pipeline/step8_integrate-peakvi.RData")
...
note <- paste0("This is adding all the motif information to Writeup6b/Writeup6b_all-data.RData. ",
               "All cells with posterior_assignment<0.5 were removed.")
