...
cell_imputed_score[names(simulation_res$cell_fate_potential_truth)] <- simulation_res$cell_fate_potential_truth
...
plot1 <- multiomeFate:::plot_cellGrowthUmap(
  ...
  title = "Plastic setting: True fate potential"
)

ggplot2::ggsave(filename = paste0(plot_folder, "Writeup17b_plastic_fatepotential-true.png"),
                plot1, width = 5, height = 4.5, units = "in")
ggplot2::ggsave(filename = paste0(plot_folder, "Writeup17b_plastic_fatepotential-true.pdf"),
                plot1, width = 5, height = 4.5, units = "in")
...
plot1 <- multiomeFate:::plot_cellGrowthUmap(
  ...
  na_color = all_data@misc$fatepotential_na_colors,
  reduction = "ft.COCL2.umap",
  title = "Plastic setting: Estimated fate potential"
)

ggplot2::ggsave(filename = paste0(plot_folder, "Writeup17b_plastic_fatepotential-estimate.png"),
                plot1, width = 5, height = 4.5, units = "in")
ggplot2::ggsave(filename = paste0(plot_folder, "Writeup17b_plastic_fatepotential-estimate.pdf"),
                plot1, width = 5, height = 4.5, units = "in")


# tne the cospar bias
# add cospar
df <- read.csv(paste0(csv_folder, "simulation_plastic_cospar_obs.csv"))
rownames(df) <- df$X
...
plot1 <- multiomeFate:::plot_cellGrowthUmap(
  ...
  na_color = all_data@misc$fatepotential_na_colors,
  reduction = "ft.COCL2.umap",
  title = "Plastic setting: CoSPAR"
)

ggplot2::ggsave(filename = paste0(plot_folder, "Writeup17b_plastic_cospar.png"),
                plot1, width = 5, height = 4.5, units = "in")
ggplot2::ggsave(filename = paste0(plot_folder, "Writeup17b_plastic_cospar.pdf"),
                plot1, width = 5, height = 4.5, units = "in")
...
ggplot2::ggsave(filename = paste0(plot_folder, "Writeup17b_plastic_true-status.png"),
                plot1, width = 5, height = 4.5, units = "in")
ggplot2::ggsave(filename = paste0(plot_folder, "Writeup17b_plastic_true-status.pdf"),
                plot1, width = 5, height = 4.5, units = "in")
