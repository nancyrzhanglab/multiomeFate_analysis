...
load("../../../../out/kevin/Writeup4d/Writeup4d_timeAll_fasttopics_CIS.RData")
load("../../../../out/kevin/Writeup4d/Writeup4d_timeAll_saver_onlyRNA_CIS-subset.RData")
load("../../../../out/kevin/Writeup4d/Writeup4d_spliced_mat_CIS_full.RData")
load("../../../../out/kevin/Writeup4d/Writeup4d_unspliced_mat_CIS_full.RData")
...
load("../../../../out/kevin/Writeup4d/Writeup4d_info_CIS_full.RData")
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("CIS: ATAC"))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup4d/Writeup4d_atac_umap-cis.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")

plot1 <-Seurat::DimPlot(all_data_subset, reduction = "maestro.umap",
                        group.by = "dataset", label = TRUE,
                        repel = TRUE, label.size = 2.5)
plot1 <- plot1 + ggplot2::ggtitle(paste0("CIS: ATAC (Maestro)"))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup4d/Writeup4d_atac-maestro_umap-cis.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")

plot1 <-Seurat::DimPlot(all_data_subset, reduction = "activity.umap",
                        group.by = "dataset", label = TRUE,
                        repel = TRUE, label.size = 2.5)
plot1 <- plot1 + ggplot2::ggtitle(paste0("CIS: ATAC (Gene activity)"))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup4d/Writeup4d_atac-activity_umap-cis.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")

plot1 <-Seurat::DimPlot(all_data_subset, reduction = "umap",
                        group.by = "dataset", label = TRUE,
                        repel = TRUE, label.size = 2.5)
plot1 <- plot1 + ggplot2::ggtitle(paste0("CIS: RNA (Log-normalized)"))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup4d/Writeup4d_rna_umap-cis.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")

plot1 <-Seurat::DimPlot(all_data_subset, reduction = "saverumap",
                        group.by = "dataset", label = TRUE,
                        repel = TRUE, label.size = 2.5)
plot1 <- plot1 + ggplot2::ggtitle(paste0("CIS: RNA (SAVER)"))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup4d/Writeup4d_rna-saver_umap-cis.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")
