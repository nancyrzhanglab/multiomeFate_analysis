...
load("../../../../out/kevin/Writeup4d/Writeup4d_timeAll_saver_onlyRNA_DABTRAM-subset.RData")
load("../../../../out/kevin/Writeup4d/Writeup4d_spliced_mat_DABTRAM_full.RData")
load("../../../../out/kevin/Writeup4d/Writeup4d_unspliced_mat_DABTRAM_full.RData")
...
maestro_day10 <- readRDS("~/project/Multiome_fate/BarcodeOutputs/2022_02/Sijia_outputs/maestro/time10_dabtram_202204/MAESTRO_arc10_dabtram_rpmatrix.RDS")
maestro_week5 <- readRDS("~/project/Multiome_fate/BarcodeOutputs/2022_02/Sijia_outputs/maestro/week5_dabtram_202204/MAESTRO_week5_dabtram_rpmatrix.RDS")

load("../../../../out/kevin/Writeup4d/Writeup4d_scvelo_umap_DABTRAM.RData")
cellIDb <- cellID
geneNameb <- geneName

load("../../../../out/kevin/Writeup4d/Writeup4d_info_DABTRAM_full.RData")
...
colnames(maestro_day10) <- paste0("day10_DABTRAM_", colnames(maestro_day10))
colnames(maestro_week5) <- paste0("week5_DABTRAM_", colnames(maestro_week5))
...
save(all_data_subset, date_of_run, session_info,
     file = "../../../../out/kevin/Writeup4d/Writeup4d_timeAll_splicedUnspliced_seuratMerge_DABTRAM.RData")
...
plot1 <- plot1 + ggplot2::ggtitle(paste0("DABTRAM: ATAC"))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup4d/Writeup4d_atac_umap-dabtram.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")

plot1 <-Seurat::DimPlot(all_data_subset, reduction = "maestro.umap",
                        group.by = "dataset", label = TRUE,
                        repel = TRUE, label.size = 2.5)
plot1 <- plot1 + ggplot2::ggtitle(paste0("DABTRAM: ATAC (Maestro)"))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup4d/Writeup4d_atac-maestro_umap-dabtram.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")

plot1 <-Seurat::DimPlot(all_data_subset, reduction = "activity.umap",
                        group.by = "dataset", label = TRUE,
                        repel = TRUE, label.size = 2.5)
plot1 <- plot1 + ggplot2::ggtitle(paste0("DABTRAM: ATAC (Gene activity)"))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup4d/Writeup4d_atac-activity_umap-dabtram.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")

plot1 <-Seurat::DimPlot(all_data_subset, reduction = "umap",
                        group.by = "dataset", label = TRUE,
                        repel = TRUE, label.size = 2.5)
plot1 <- plot1 + ggplot2::ggtitle(paste0("DABTRAM: RNA (Log-normalized)"))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup4d/Writeup4d_rna_umap-dabtram.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")

plot1 <-Seurat::DimPlot(all_data_subset, reduction = "saverumap",
                        group.by = "dataset", label = TRUE,
                        repel = TRUE, label.size = 2.5)
plot1 <- plot1 + ggplot2::ggtitle(paste0("DABTRAM: RNA (SAVER)"))
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup4d/Writeup4d_rna-saver_umap-dabtram.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")
...
png("../../../../out/figures/Writeup4d/tmp.png", 
    height = 2000, width = 3000, units = "px", res = 300)
par(mar = c(4, 4, 4, 0.5), mfrow = c(1,3))
plot(x = all_data_subset[["spliced"]]@data["ENTPD4",cell_idx],
     y = all_data_subset[["unspliced"]]@data["ENTPD4",cell_idx],
     pch = 16, col = col_vec[cell_idx])
plot(x = all_data_subset[["spliced"]]@data["SLC38A11",cell_idx],
     y = all_data_subset[["unspliced"]]@data["SLC38A11",cell_idx],
     pch = 16, col = col_vec[cell_idx])
plot(x = all_data_subset[["spliced"]]@data["PCDH7",cell_idx],
     y = all_data_subset[["unspliced"]]@data["PCDH7",cell_idx],
     pch = 16, col = col_vec[cell_idx])
graphics.off()
