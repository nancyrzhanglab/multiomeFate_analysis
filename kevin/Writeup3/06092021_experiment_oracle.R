...
save.image(file = "../../out/writeup3/06092021_oracle.RData")

#############

pred_y <- .predict_yfromx(mat_x, res$res_g, family = "gaussian")
png(file = paste0("../../out/fig/writeup3/06092021_oracle_rna_prediction.png"),
    height = 1500, width = 1500, res = 300, units = "px")
image(.rotate(pred_y), zlim = range(mat_y))
graphics.off()


png(file = "../../out/fig/writeup3/06092021_oracle_prediction_correlation.png",
    height = 1500, width = 1500, res = 300, units = "px")
...
png(file = "../../out/fig/writeup3/06092021_oracle_atac_umap_timeoverlay.png",
