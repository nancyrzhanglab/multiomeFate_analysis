...
for(kk in 1:length(file_vec)){
  ...
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup18_", file, "_fatepotential-violinplot.png"),
                  plot1, width = 6, height = 3, units = "in")
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup18_", file, "_fatepotential-violinplot.pdf"),
                  plot1, width = 6, height = 2, units = "in")
  ...
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup18_",  file, "_fatepotential-lineage_prediction.png"),
                  plot1, width = 10, height = 10, units = "in")
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup18_",  file, "_fatepotential-lineage_prediction.pdf"),
                  plot1, width = 5, height = 5, units = "in")
  ...
  plot1 <- multiomeFate:::plot_cellGrowthUmap(
    ...
    cell_imputed_score = cell_imputed_score,
    colors_use = rev(all_data2@misc$fatepotential_colors),
  ...
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup18_", file,  "_fatepotential-umap.png"),
                  plot1, width = 5, height = 5, units = "in")
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup18_", file,  "_fatepotential-umap.pdf"),
                  plot1, width = 5, height = 5, units = "in")
