...
for(treatment in treatment_vec){
  ...
  ggplot2::ggsave(filename = paste0("~/project/Multiome_fate/out/figures/Writeup9/Writeup9_", treatment, "_umap.png"),
                  plot1, device = "png", width = 6, height = 4, units = "in")
  
  ###################
  
  load(paste0("~/project/Multiome_fate/out/kevin/Writeup9/Writeup9_", treatment, "_from_day", day_early, "_lineage-imputation.RData"))
  ...
  png(paste0("~/project/Multiome_fate/out/figures/Writeup9/Writeup9_",
  ...
  lineage_vec <- seurat_object$assigned_lineage[names(cell_imputed_score)]
  ...
  ggplot2::ggsave(filename = paste0("~/project/Multiome_fate/out/figures/Writeup9/Writeup9_",
  ...
  ggplot2::ggsave(filename = paste0("~/project/Multiome_fate/out/figures/Writeup9/Writeup9_", treatment, 
  ...
  save(cell_features,
       ...
       file = paste0("~/project/Multiome_fate/out/kevin/Writeup9/Writeup9_", treatment, "_from_day", day_early, "_postprocess.RData")
  )
