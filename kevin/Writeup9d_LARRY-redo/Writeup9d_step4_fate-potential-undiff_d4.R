...
fit_res <- multiomeFate:::lineage_cv(
  ...
  tab_mat = tab_mat,
  num_folds = 20,
  savefile_tmp = paste0("~/project/Multiome_fate/out/kevin/Writeup9d/Writeup9d_", treatment, "_from_day", day_early, "_lineage-imputation_tmp.RData"),
  verbose = 4
)

save(date_of_run, session_info,
     fit_res,
     file = paste0("~/project/Multiome_fate/out/kevin/Writeup9d/Writeup9d_", treatment, "_from_day", day_early, "_lineage-imputation.RData"))
