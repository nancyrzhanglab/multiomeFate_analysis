...
load("../../../../out/kevin/Writeup6k/Writeup6k_DABTRAM_day10_lineage-imputation_stepup_step2.RData")
...
png("../../../../out/figures/Writeup6k/Writeup6k_DABTRAM-day10_imputation_stepup_loglikelihood.png", 
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6k/Writeup6k_DABTRAM-day10_imputation_stepup_umap.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6k/Writeup6k_DABTRAM-day10_imputation_stepup_lineage-level_counts_labeled.png"),
...
save(all_data, all_data2, fit, lineage_future_count,
     ...
     file = "../../../../out/kevin/Writeup6k/Writeup6k_DABTRAM_day10_lineage-imputation_stepup_postprocessed.RData")
