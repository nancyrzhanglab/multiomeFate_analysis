...
lineage_idx <- intersect(which(tab_mat[,"day10_COCL2"] >= 4),
                         which(tab_mat[,"week5_COCL2"] >= 20))
...
for(lineage in large_lineages){
  ...
  lineage_name <- paste0(lineage, "_W5:", tab_mat[lineage,"week5_COCL2"])
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6k/Writeup6k_COCL2-day10_imputation_stepdown-violinplot.png"),
