...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6k/Writeup6k_DABTRAM-day0_stepup_DE_volcano.png"),
...
pdf("../../../../out/figures/Writeup6k/Writeup6k_DABTRAM-day0_stepup_DE_violin_highest-DE.pdf", 
...
pdf("../../../../out/figures/Writeup6k/Writeup6k_DABTRAM-day10_stepdown_DE_violin_keygenes.pdf", 
    onefile = T, width = 5, height = 5)
