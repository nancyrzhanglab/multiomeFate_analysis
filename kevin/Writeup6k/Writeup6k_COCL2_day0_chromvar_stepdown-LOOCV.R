...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6k/Writeup6k_COCL2_day0_chromvar_stepdown-LOOCV.png"),
...
p1 <- p1 + ggplot2::ggtitle(paste0("COCL2 Day0 Motif, based on growth potential\n(Winner-Loser)")) +
  ggplot2::xlab("Mean difference in chromVar score: (Winner-Loser)") + ggplot2::ylab("DE p-value (-Log10)")
p1 <- p1 + Seurat::NoLegend()

ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6k/Writeup6k_COCL2_day0_chromvar_stepdown-LOOCV_DE_volcano.png"),
