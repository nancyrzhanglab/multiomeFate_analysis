...
load("../../../../out/kevin/Writeup6k/Writeup6k_DABTRAM_day10_lineage-imputation_stepdown.RData")
...
loocv_lineages <- rownames(tab_mat)[intersect(which(tab_mat[,"week5_DABTRAM"] >= 20),
                                              which(tab_mat[,"day10_DABTRAM"] >= 1))]
...
for(iteration in 1:len){
  ...
  save(coefficient_list_list, loocv_mat, date_of_run, session_info,
       file = "../../../../out/kevin/Writeup6k/Writeup6k_DABTRAM_day10_lineage-imputation_stepdown_step2.RData")
} 
