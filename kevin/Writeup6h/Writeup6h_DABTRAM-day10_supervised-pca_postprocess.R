...
library(IRanges)
load("../../../../out/kevin/Writeup6h/Writeup6h_DABTRAM-day10_supervised-pca.RData")
...
idx <- unique(c(which(is.null(spca_rna_importance)), 
                which(is.null(cv_score_vec))))
if(length(idx) != 0){
  spca_rna_importance <- spca_rna_importance[-idx]
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6h/Writeup6h_DABTRAM-day10_spca_all-genes.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6h/Writeup6h_DABTRAM-day10_spca_high-rna.png"),
                p1, device = "png", width = 10, height = 10, units = "in")
...
for(kk in 1:2){
  ...
  png(paste0("../../../../out/figures/Writeup6h/Writeup6h_day10_spca_leafplot_", treatment, "_largest-cv_", kk, ".png"),
