...
library(IRanges)
load("../../../../out/kevin/Writeup6h/Writeup6h_DABTRAM_supervised-pca_day10-to-week5.RData")
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6h/Writeup6h_DABTRAM_supervised-pca_day10-to-week5_all-genes.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6h/Writeup6h_DABTRAM_supervised-pca_day10-to-week5_high-rna.png"),
                p1, device = "png", width = 10, height = 10, units = "in")
...
for(kk in 1:2){
  ...
  png(paste0("../../../../out/figures/Writeup6h/Writeup6h_DABTRAM_supervised-pca_day10-to-week5_leafplot_", treatment, "_largest-cv_", kk, ".png"),
