...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6h/Writeup6h_tcca-RNA-ATAC_DABTRAM_frontrunner-", min_cell_count, ".png"),
...
png(paste0("../../../../out/figures/Writeup6h/Writeup6h_tcca-RNA-ATAC_DABTRAM_frontrunner-", min_cell_count, "_synchrony.png"),
...
png(paste0("../../../../out/figures/Writeup6h/Writeup6h_tcca-RNA-ATAC_DABTRAM_synchrony.png"),
    height = 2000, width = 2000, units = "px", res = 500)
plot(x = dabtram_only@reductions[["umap"]]@cell.embeddings[,1],
     y = dabtram_only@reductions[["umap"]]@cell.embeddings[,2],
     col = color_vec, pch = 16,
...
png(paste0("../../../../out/figures/Writeup6h/Writeup6h_tcca-RNA-ATAC_DABTRAM_synchrony-histogram.png"),
...
png(paste0("../../../../out/figures/Writeup6h/Writeup6h_tcca-RNA-ATAC_DABTRAM_synchrony-vs-number.png"),
    height = 2000, width = 2000, units = "px", res = 500)
