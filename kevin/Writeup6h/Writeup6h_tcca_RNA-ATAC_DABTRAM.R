...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6h/Writeup6h_tcca_RNA-ATAC_DABTRAM_laplacian.png"),
...
save(multiSVD_obj, all_data,
     ...
     file = "../../../../out/kevin/Writeup6h/Writeup6h_tcca_RNA-ATAC_DABTRAM.RData")
