...
SeuratDisk::SaveH5Seurat(all_data, filename = "../../../../out/kevin/Writeup6o/Writeup6o_all-data-atac_CIS_lightweight.h5Seurat")
SeuratDisk::Convert("../../../../out/kevin/Writeup6o/Writeup6o_all-data-atac_CIS_lightweight.h5Seurat", dest = "h5ad", misc = F)
