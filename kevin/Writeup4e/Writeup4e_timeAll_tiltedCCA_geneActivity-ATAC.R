...
mat_1 <- Matrix::t(all_data[["geneActivity"]]@data[Seurat::VariableFeatures(object = all_data),])
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup4e/Writeup4e_tcca_geneActivity-ATAC_laplacian.png"),
...
save(multiSVD_obj, all_data,
     ...
     file = "../../../../out/kevin/Writeup4e/Writeup4e_tcca_geneActivity-ATAC.RData")
