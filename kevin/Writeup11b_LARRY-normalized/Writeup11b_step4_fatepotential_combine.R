...
out_folder <- "/home/stat/nzh/team/kevinl1/project/Multiome_fate/out/kevin/Writeup11b/"
plot_folder <- "/home/stat/nzh/team/kevinl1/project/Multiome_fate/out/figures/kevin/Writeup11b/"
load(paste0(out_folder, "Writeup11b_larry_fasttopics.RData"))

file_vec <- c(Monocyte_d2_d4 = "Writeup11b_fatepotential_for_Monocyte-4.RData",
              Monocyte_d4_d6 = "Writeup11b_fatepotential_for_Monocyte-6.RData",
              Neutrophil_d2_d4 = "Writeup11b_fatepotential_for_Neutrophil-4.RData",
              Neutrophil_d4_d6 = "Writeup11b_fatepotential_for_Neutrophil-6.RData",
              Undifferentiated_d2_d4 = "Writeup11b_fatepotential_for_Undifferentiated-4.RData",
              Undifferentiated_d4_d6 = "Writeup11b_fatepotential_for_Undifferentiated-6.RData")
...
for(kk in 1:length(file_vec)){
  ...
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup11b_", filename, "_train-test-curve.png"),
...
save(seurat_obj, date_of_run, session_info,
     file = paste0(out_folder, "Writeup11b_larry_fatepotential.RData"))
