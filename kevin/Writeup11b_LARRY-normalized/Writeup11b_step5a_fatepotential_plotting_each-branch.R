...
load(paste0(out_folder, "Writeup11b_larry_fatepotential.RData"))
...
for(kk in 1:length(file_vec)){
  ...
  plot1 <- multiomeFate:::plot_anova(seurat_obj = seurat_obj,
                                     ...
                                     ylim = c(max(stats::quantile(cell_imputed_score, na.rm = TRUE, prob = 0.05), -5), 
                                              NA))
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup11b_", file, "_fatepotential-violinplot.png"),
  ...
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup11b_", file, "_fatepotential-umap.png"),
  ...
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup11b_", file, "_fatepotential-lineage_prediction.png"),
