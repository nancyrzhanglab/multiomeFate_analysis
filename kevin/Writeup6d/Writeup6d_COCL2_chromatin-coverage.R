...
for(i in 1:length(gene_vec)){
  ...
  if(!is.null(window_size)){
    ...
    png(paste0("../../../../out/figures/Writeup6d/Writeup6d_COCL2_coverage_", gene_vec[i], ".png"),
    ...
    plot_coveragetracks(
      ...
      main = paste0("COCL2: Winning for ", gene_vec[i]),
    ...
    plot_coveragetracks(
      ...
      main = paste0("COCL2: Losing for ", gene_vec[i], " (Subsampled)"),
