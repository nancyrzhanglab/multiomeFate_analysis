...
save(date_of_run, session_info, de_res,
     file = "../../../../out/kevin/Writeup6d/Writeup6d_DABTRAM_differential-peak.RData")
...
write_peakfile(pos_ranges, 
               file = "../../../../out/kevin/Writeup6d/Writeup6d_DABTRAM_differential_pospeaks.txt")

write_peakfile(neg_ranges, 
               file = "../../../../out/kevin/Writeup6d/Writeup6d_DABTRAM_differential_negpeaks.txt")

write_peakfile(bg_ranges, 
               file = "../../../../out/kevin/Writeup6d/Writeup6d_DABTRAM_differential_bgpeaks.txt")
