...
# png("../../../../out/figures/Writeup6d/Writeup6d_DABTRAM_winning-day0_coverage_CD44.png",
#     height = 2500, width = 2500, units = "px", res = 300)
# par(mar = c(4,4,4,0.5))
# plot_coveragetracks(
#   cutmat = winning_tracks,
#   peaks = peaks,
#   max_height = max(winning_tracks@x)/2,
#   main = "DABTRAM: Winning for CD44"
# )
# graphics.off()
# 
# 
# png("../../../../out/figures/Writeup6d/Writeup6d_DABTRAM_losing-day0_coverage_CD44.png",
#     height = 2500, width = 2500, units = "px", res = 300)
# par(mar = c(4,4,4,0.5))
# plot_coveragetracks(
#   cutmat = dying_tracks,
#   peaks = peaks,
#   max_height = max(dying_tracks@x)/2,
#   main = "DABTRAM: Losing for CD44"
# )
# graphics.off()
...
for(i in 1:length(peaks_list)){
  ...
  png(paste0("../../../../out/figures/Writeup6d/Writeup6d_DABTRAM_coverage_", names(peaks_list)[i], ".png"),
  ...
  plot_coveragetracks(
    ...
    main = paste0("DABTRAM: Winning for ", names(winning_tracks_list)[i]),
  )
  ...
  plot_coveragetracks(
    ...
    main = paste0("DABTRAM: Losing for ", names(dying_tracks_list)[i], " (Subsampled)"),
  )
