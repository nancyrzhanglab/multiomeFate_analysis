...
load("../../../../out/kevin/Writeup6d/Writeup6d_DABTRAM_differential-peak_day10-week5.RData")
...
write_peakfile(pos_ranges, 
               file = "../../../../out/kevin/Writeup6d/Writeup6d_DABTRAM_day10-week5_differential_pospeaks.txt")

write_peakfile(neg_ranges, 
               file = "../../../../out/kevin/Writeup6d/Writeup6d_DABTRAM_day10-week5_differential_negpeaks.txt")

write_peakfile(bg_ranges, 
               file = "../../../../out/kevin/Writeup6d/Writeup6d_DABTRAM_day10-week5_differential_bgpeaks.txt")
