...
load("../../../../out/kevin/Writeup6i/Writeup6i_DABTRAM_lineage-imputation_stepdown_multiple-run2.RData")
...
png("../../../../out/figures/Writeup6i/Writeup6i_DABTRAM-day10_imputation_stepdown-variable_loglikelihood_banded2.png", 
...
selected_vars <- names(coefficient_list_list[[which(colnames(test_mat) == "Num16")]][[1]]$coefficient_vec)

# > selected_vars
# [1] "Intercept"           "fastTopicDABTRAM_10" "fastTopicDABTRAM_11"
# [4] "fastTopicDABTRAM_12" "fastTopicDABTRAM_17" "fastTopicDABTRAM_19"
# [7] "fastTopicDABTRAM_21" "fastTopicDABTRAM_24" "fastTopicDABTRAM_27"
# [10] "fastTopicDABTRAM_29" "fastTopicDABTRAM_30" "LSI_2"              
# [13] "LSI_6"               "LSI_22"              "LSI_24"             
# [16] "LSI_35" 
...
cell_features <- cbind(1, 
                       scale(fasttopic_mat[,c(10,11,12,17,19,21,24,27,29,30)]), 
                       scale(lsi_mat[,c(2,6,22,24,35)]))
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6i/Writeup6i_DABTRAM-day10_imputed-lineage_stepdown_umap2.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6i/Writeup6i_DABTRAM-day10_imputed-lineage_stepdown_lineage-level_counts_labeled2.png"),
