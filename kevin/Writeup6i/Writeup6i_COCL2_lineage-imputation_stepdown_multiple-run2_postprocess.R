...
load("../../../../out/kevin/Writeup6i/Writeup6i_COCL2_lineage-imputation_stepdown_multiple-run2.RData")
...
png("../../../../out/figures/Writeup6i/Writeup6i_COCL2-day10_imputation_stepdown-variable_loglikelihood_banded2.png", 
...
plot(NA, xlim = range(len_vec), ylim = ylim, 
     ...
     main = "Stepdown variable selection: COCL2\nBlack:Train, Red:Test")
...
# > selected_vars
# [1] "Intercept"         "fastTopicCOCL2_12" "fastTopicCOCL2_22"
# [4] "LSI_3"             "LSI_5"
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6i/Writeup6i_COCL2-day10_imputed-lineage_stepdown_umap2.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6i/Writeup6i_COCL2-day10_imputed-lineage_stepdown_lineage-level_counts_labeled2.png"),
