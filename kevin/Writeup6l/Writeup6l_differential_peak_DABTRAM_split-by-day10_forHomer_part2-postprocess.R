...
load("../../../../out/kevin/Writeup6l/Writeup6l_differential_peak_DABTRAM_split-by-day10_part2.RData")
...
p1 <- p1 + ggplot2::ggtitle(paste0("DABTRAM (Day0 winners vs Day0 losers, split by Day10):\nPositive peaks")) 
p1 <- p1 + Seurat::NoLegend()

ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6l/Writeup6l_differential_peak_DABTRAM_split-by-day10_positive-peaks.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6l/Writeup6l_differential_peak_DABTRAM_split-by-day10_negative-peaks.png"),
                p1, device = "png", width = 10, height = 10, units = "in")
