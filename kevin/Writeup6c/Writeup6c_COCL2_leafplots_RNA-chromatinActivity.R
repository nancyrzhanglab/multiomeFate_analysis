...
png(paste0("../../../../out/figures/Writeup6c/Writeup6c_COCL2_RNA-chromAct_leafplot_genes_highest-correlation.png"),
...
png(paste0("../../../../out/figures/Writeup6c/Writeup6c_COCL2_RNA-chromAct_leafplot_genes_random-forest.png"),
    height = 3000, width = 3000, units = "px", res = 300)
par(mar = c(4,4,4,0.5), mfrow = c(5,5))
for(j in gene_idx){
  plot(x = atac_pred[cell_idx[rng_idx],j],
...
png(paste0("../../../../out/figures/Writeup6c/Writeup6c_COCL2_RNA-chromAct_histogram_correlation_random-forest.png"),
