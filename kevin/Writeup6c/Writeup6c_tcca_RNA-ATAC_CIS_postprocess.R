...
library(Seurat)
library(Signac)
load("../../../../out/kevin/Writeup6c/Writeup6c_tcca_RNA-ATAC_CIS.RData")
...
all_data <- Seurat::RunUMAP(all_data, reduction.key="ftUMAP", reduction = "fasttopic_CIS", dims=c(1:30))

# How many cells need to be seen to count as "win"?
min_cell_count <- 50
earlierday_cond_str <- "day10_CIS"
later_cond <- "week5_CIS"
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca-RNA-ATAC_CIS_frontrunner-", min_cell_count, ".png"),
...
png(paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca-RNA-ATAC_CIS_frontrunner-", min_cell_count, "_synchrony.png"),
...
png(paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca-RNA-ATAC_CIS_synchrony.png"),
    height = 2000, width = 2000, units = "px", res = 500)
plot(x = all_data@reductions[["umap"]]@cell.embeddings[,1],
     y = all_data@reductions[["umap"]]@cell.embeddings[,2],
     col = color_vec, pch = 16,
...
png(paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca-RNA-ATAC_CIS_synchrony-histogram.png"),
...
cell_idx <- intersect(intersect(which(all_data$dataset == "day10_CIS"),
...
png(paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca-RNA-ATAC_CIS_synchrony-vs-number.png"),
    height = 2000, width = 2000, units = "px", res = 500)
plot(alignment_vec, log1p(future_num_vec),
     xlab = "CIS day10 synchrony",
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca-RNA-ATAC_CIS_umap_common.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca-RNA-ATAC_CIS_umap_distinct1.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca-RNA-ATAC_CIS_umap_distinct2.png"),
