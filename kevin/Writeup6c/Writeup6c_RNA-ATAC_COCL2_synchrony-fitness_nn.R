...
png(paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca-RNA-ATAC_COCL2_frontrunner-", min_cell_count, "_synchrony_nn.png"),
...
png(paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca-RNA-ATAC_COCL2_synchrony_nn.png"),
    height = 2000, width = 2000, units = "px", res = 500)
plot(x = all_data@reductions[["umap"]]@cell.embeddings[,1],
     y = all_data@reductions[["umap"]]@cell.embeddings[,2],
     col = color_vec, pch = 16,
...
png(paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca-RNA-ATAC_COCL2_synchrony-histogram_nn.png"),
