...
all_data <- subset(all_data, dataset %in% c("day0", "day10_CIS", "week5_CIS"))
n <- ncol(all_data)
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca_RNA-ATAC_CIS_laplacian.png"),
...
save(multiSVD_obj, all_data,
     ...
     file = "../../../../out/kevin/Writeup6c/Writeup6c_tcca_RNA-ATAC_CIS.RData")
