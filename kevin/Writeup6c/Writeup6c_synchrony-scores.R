rm(list=ls())
library(Seurat); library(Signac); library(tiltedCCA)
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca_RNA-ATAC_umap_common.png"),
                plot1, device = "png", width = 6, height = 5, units = "in")


png(paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca_RNA-ATAC_steadystate.png"),
...
note <- "Synchrony score calculated from Writeup6c_synchrony-scores.R, based on Writeup4e_tcca_RNA-ATAC.RData"
save(session_info, date_of_run, alignment_vec, note,
     file = "../../../../out/kevin/Writeup6c/Writeup6c_synchrony-score.RData")
