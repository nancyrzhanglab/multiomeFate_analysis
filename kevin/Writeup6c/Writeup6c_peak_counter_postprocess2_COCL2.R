...
peak_plotting_func(active_gene_vec = active_gene_vec, 
                   ...
                   filename = "../../../../out/figures/Writeup6c/Writeup6c_COCL2_peakcounter_plotter_num-active-genes.png",
...
peak_plotting_func(active_gene_vec = active_gene_vec2, 
                   ...
                   survive_idx = survive_idx, die_idx = die_idx, unknown_idx = unknown_idx,
                   survive_idx2 = survive_idx2, die_idx2 = die_idx2,
                   filename = "../../../../out/figures/Writeup6c/Writeup6c_COCL2_peakcounter_plotter_num-active-genes_threshold.png",
                   condition_name = "COCL2",
...
peak_plotting_func(active_gene_vec = active_gene_vec, 
                   ...
                   survive_idx = survive_idx, die_idx = die_idx, unknown_idx = unknown_idx,
                   survive_idx2 = survive_idx2, die_idx2 = die_idx2,
                   filename = "../../../../out/figures/Writeup6c/Writeup6c_COCL2_peakcounter_plotter_num-offpeak-active-genes.png",
                   condition_name = "COCL2",
...
peak_plotting_func(active_gene_vec = active_gene_vec, 
                   ...
                   survive_idx = survive_idx, die_idx = die_idx, unknown_idx = unknown_idx,
                   survive_idx2 = survive_idx2, die_idx2 = die_idx2,
                   filename = "../../../../out/figures/Writeup6c/Writeup6c_COCL2_peakcounter_plotter_sum-offpeak.png",
                   condition_name = "COCL2",
...
peak_plotting_func(active_gene_vec = active_gene_vec, 
                   ...
                   survive_idx = survive_idx, die_idx = die_idx, unknown_idx = unknown_idx,
                   survive_idx2 = survive_idx2, die_idx2 = die_idx2,
                   filename = "../../../../out/figures/Writeup6c/Writeup6c_COCL2_peakcounter_plotter_sum-normalized-offpeak.png",
                   condition_name = "COCL2",
...
peak_plotting_func(active_gene_vec = active_gene_vec, 
                   ...
                   survive_idx = survive_idx, die_idx = die_idx, unknown_idx = unknown_idx,
                   survive_idx2 = survive_idx2, die_idx2 = die_idx2,
                   filename = "../../../../out/figures/Writeup6c/Writeup6c_COCL2_peakcounter_plotter_sum-tfidf-offpeak.png",
                   condition_name = "COCL2",
