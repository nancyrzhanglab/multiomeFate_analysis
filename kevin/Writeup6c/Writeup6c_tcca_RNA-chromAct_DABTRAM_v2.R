...
all_data[["onpeak"]] <- Seurat::CreateAssayObject(counts = Matrix::t(countmat_nopeak))
Seurat::DefaultAssay(all_data) <- "onpeak"
...
Seurat::DefaultAssay(all_data) <- "onpeak"
mat_2 <- Matrix::t(all_data[["onpeak"]]@data)
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6c/Writeup6c_tcca_RNA-chromAct_DABTRAM_v2_laplacian.png"),
...
save(multiSVD_obj, all_data,
     ...
     file = "../../../../out/kevin/Writeup6c/Writeup6c_tcca_RNA-chromAct_DABTRAM_v2.RData")
