...
save(date_of_run, session_info,
     training_list,
     file = "../../../../out/kevin/Writeup6j/Writeup6j_COCL2_day10_lineage-imputation_stepwise-up_training.RData")
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6j/Writeup6j_COCL2-day10_imputation_stepup_umap.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6j/Writeup6j_COCL2-day10_imputation_stepup_lineage-level_counts_labeled.png"),
