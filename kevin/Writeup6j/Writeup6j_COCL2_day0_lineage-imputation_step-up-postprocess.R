...
save(date_of_run, session_info,
     training_list,
     file = "../../../../out/kevin/Writeup6j/Writeup6j_COCL2_day0_lineage-imputation_stepwise-up_training.RData")
...
png("../../../../out/figures/Writeup6j/Writeup6j_COCL2-day0_imputation_stepup_loglikelihood.png", 
...
p1 <- p1 + ggplot2::ggtitle("COCL2 Day0 imputed counts\n(Stepup from RNA fasttopics, ATAC LSI), (Log-scale)")
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6j/Writeup6j_COCL2-day0_imputation_stepup_umap.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6j/Writeup6j_COCL2-day0_imputation_stepup_lineage-level_counts_labeled.png"),
