...
load("../../../../out/kevin/Writeup6j/Writeup6j_COCL2_day0_lineage-imputation_step-down_LOOCV.RData")
...
png("../../../../out/figures/Writeup6j/Writeup6j_COCL2-day0_imputation_stepdown-LOOCV_loglikelihood.png", 
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6j/Writeup6j_COCL2-day0_imputation_stepdown-LOOCV_umap.png"),
