...
loocv_lineages <- rownames(tab_mat)[intersect(which(tab_mat[,"day10_COCL2"] >= 20),
...
for(iteration in 1:len){
  ...
  save(coefficient_list_list, loocv_mat, date_of_run, session_info,
       file = "../../../../out/kevin/Writeup6j/Writeup6j_COCL2_day0_lineage-imputation_step-up_step2.RData")
} 
