...
loocv_lineages <- rownames(tab_mat)[intersect(which(tab_mat[,"day10_DABTRAM"] >= 25),
  ...
  if(iteration > 1){
    ...
    for(variable in var_rm){
      ...
      save(coefficient_list_list, loocv_mat, date_of_run, session_info,
           file = "../../../../out/kevin/Writeup6j/Writeup6j_DABTRAM_day0_lineage-imputation_step-down_LOOCV.RData")
    } 
