...
treatment <- "COCL2"
load(paste0("../../../../out/kevin/Writeup6p/Writeup6p_", treatment, "_day0_lineage-imputation_stepdown.RData"))
...
for(iteration in 1:len){
  ...
  save(coefficient_list_list, loocv_mat, date_of_run, session_info,
       file = paste0("../../../../out/kevin/Writeup6p/Writeup6p_", treatment, "_day0_lineage-imputation_stepdown_step2-tmp.RData"))
} 
...
save(date_of_run, session_info,
     ...
     loocv_mat,
     tab_mat,
     file = paste0("../../../../out/kevin/Writeup6p/Writeup6p_", treatment, "_day0_lineage-imputation_stepdown_step2.RData"))
