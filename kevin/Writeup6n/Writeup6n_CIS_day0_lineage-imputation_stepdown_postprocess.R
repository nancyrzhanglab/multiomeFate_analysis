...
treatment <- "CIS"
load(paste0("../../../../out/kevin/Writeup6n/Writeup6n_", treatment, "_day0_lineage-imputation_stepdown_step2.RData"))
...
png("../../../../out/figures/Writeup6n/Writeup6n_CIS-day0_lineage-imputation_loglikelihood.png", 
...
plot(NA, xlim = range(len_vec), ylim = ylim, 
     ...
     main = "Stepdown variable selection: CIS\n(Day0->Day10, Stepdown, Training)")
...
fasttopic_mat <- all_data2[[paste0("fasttopic_", treatment)]]@cell.embeddings
