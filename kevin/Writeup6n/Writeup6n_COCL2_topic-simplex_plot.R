...
cocl2_d10_v2 <- cocl2_d10 + 0.1
for(i in 1:nrow(cocl2_d10_v2)){
  cocl2_d10_v2[i,] <- cocl2_d10_v2[i,]/sum(cocl2_d10_v2[i,])
}

cocl2_d10_v2 <- cocl2_d10_v2*100
...
pdf("../../out/figures/Writeup6n/Writeup6n_COCL2_topic-simplex_normalized.pdf", 
...
for(lineage_name in lineage_names){
  ...
  p1 <- ggtern::ggtern(cocl2_d10_v3, ggplot2::aes(x = T28,
                                                  y = T21,
                                                  z = T12))
