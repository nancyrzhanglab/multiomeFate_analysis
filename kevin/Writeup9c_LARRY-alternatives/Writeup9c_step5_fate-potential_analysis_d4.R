...
for(treatment in treatment_vec){
  ...
  ggplot2::ggsave(filename = paste0("~/project/Multiome_fate/out/figures/Writeup9c/Writeup9c_", treatment, "_umap.png"),
                  plot1, device = "png", width = 6, height = 4, units = "in")
  
  ###################
  
  load(paste0("~/project/Multiome_fate/out/kevin/Writeup9c/Writeup9c_", treatment, "_from_day", day_early, "_lineage-imputation.RData"))
  ...
  png(paste0("~/project/Multiome_fate/out/figures/Writeup9c/Writeup9c_",
