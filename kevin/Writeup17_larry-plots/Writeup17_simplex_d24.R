...
# create empty plot
png(file = paste0(plot_folder, "Writeup17_d24_simplex_color-", color_by_name, "_size-", size_by, ".png"),
    width = 3000, 
    height = 2000, 
    res = 300, 
    units = "px")
...
png(file = paste0(plot_folder, "Writeup17_d24_simplex_color-", color_by_name, "_size-", size_by, "_cleaned.png"),
    width = 1500, 
    height = 1000, 
    res = 300, 
    units = "px")
