...
file_vec <- c("Mono_d2_d4", "Neu_d2_d4", "Undiff_d2_d4")
treatment_vec <- c("Monocyte", "Neutrophil", "Undifferentiated")
day_later_vec <- rep("4", 3)
day_early_vec <- rep("2", 3)
...
for(kk in 1:length(file_vec)){
  ...
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup17_", file,  "_fatepotential-umap_d24.png"),
                  plot1, device = "png", width = 5, height = 5, units = "in")
  
  
  png(paste0(plot_folder, "Writeup17_", file,  "_fatepotential-umap_cleaned_d24.png"),
  ...
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup17_",  file, "_fatepotential-lineage_prediction_cleaned_d24.png"),
  ...
  ggplot2::ggsave(filename = paste0(plot_folder, "Writeup17_",  file, "_fatepotential-lineage_prediction_d24.png"),
