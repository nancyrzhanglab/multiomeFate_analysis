...
load("../../../../out/kevin/Writeup6l/Writeup6l_CIS-split-by-day10_differential-peak.RData")
...
print("Plotting")
pdf(paste0("../../../../out/figures/Writeup6m/Writeup6m_day0_motif-peak_split-by-day10CIS_scatterplot_", motif_focus, ".pdf"),
...
for(kk in motif_idx){
  ...
  p1 <- p1 + ggplot2::ggtitle(paste0(motif, ": Percentage among winner or loser cells, defined by Day10 CIS\n",
