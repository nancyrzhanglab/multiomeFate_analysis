...
load("../../../../out/kevin/Writeup6m/Writeup6m_differential_peak_CIS_split-by-week5.RData")
...
p1 <- p1 + ggplot2::ggtitle(paste0("CIS (Day0 winners vs Day0 losers, split by Week5):\nPositive peaks")) 
p1 <- p1 + Seurat::NoLegend()

ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6m/Writeup6m_differential_peak_CIS_split-by-week5_positive-peaks.png"),
...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup6m/Writeup6m_differential_peak_CIS_split-by-week5_negative-peaks.png"),
                p1, device = "png", width = 10, height = 10, units = "in")
