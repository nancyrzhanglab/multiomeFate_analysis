...
lineage_names_win <- rownames(tab_mat)[which(tab_mat[,paste0("week5_", treatment)] >= 10)]
cell_names_win <- colnames(all_data)[which(all_data$assigned_lineage %in% lineage_names_win)]
lineage_names_lose <- rownames(tab_mat)[which(tab_mat[,paste0("week5_", treatment)] == 0)]
...
save(date_of_run, session_info,
     de_res,
     file = "../../../../out/kevin/Writeup6m/Writeup6m_differential_peak_DABTRAM_split-by-week5.RData")
