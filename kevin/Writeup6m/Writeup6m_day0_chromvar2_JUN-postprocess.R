...
load("../../../../out/kevin/Writeup6m/Writeup6m_day0_chromvar2_JUN.RData")
...
pdf("../../../../out/figures/Writeup6m/Writeup6m_chromvar2_day0_violin_day0cells_JUN.pdf", 
...
pdf("../../../../out/figures/Writeup6m/Writeup6m_chromvar2_day0_violin_day0cells_JUN_byday10DABTRAM.pdf", 
    onefile = T, width = 8, height = 5)
