...
load("../../../../out/kevin/Writeup6m/Writeup6m_day0_chromvar2_SOX.RData")
...
pdf("../../../../out/figures/Writeup6m/Writeup6m_chromvar2_day0_violin_day0cells_SOX.pdf", 
...
pdf("../../../../out/figures/Writeup6m/Writeup6m_chromvar2_day0_violin_day0cells_SOX_byday10DABTRAM.pdf", 
    onefile = T, width = 8, height = 5)
