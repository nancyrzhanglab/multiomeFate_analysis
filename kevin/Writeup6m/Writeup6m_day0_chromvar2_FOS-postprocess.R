...
pdf("../../../../out/figures/Writeup6m/Writeup6m_chromvar2_day0_violin_day0cells_FOS.pdf", 
...
pdf("../../../../out/figures/Writeup6m/Writeup6m_chromvar2_day0_violin_day0cells_FOS_byday10DABTRAM.pdf", 
    onefile = T, width = 8, height = 5)
