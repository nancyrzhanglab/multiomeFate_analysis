...
lineage_names_lose <- rownames(tab_mat)[intersect(
  which(tab_mat[,paste0("week5_", treatment)] == 0),
  which(tab_mat[,paste0("day10_", treatment)] == 0)
)]
...
save(date_of_run, session_info,
     de_res,
     file = "../../../../out/kevin/Writeup6m/Writeup6m_differential_peak_DABTRAM_day0-vs-week5.RData")
