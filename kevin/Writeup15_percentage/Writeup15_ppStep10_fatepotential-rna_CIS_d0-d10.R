...
fit_res <- multiomeFate:::lineage_cv(
  ...
  tab_mat = tab_mat,
  num_folds = 20,
  savefile_tmp = paste0(out_folder, "Writeup15_", treatment, "-from-", day_early, "_fatepotential-rna_tmp.RData"),
  verbose = 4
)

save(date_of_run, session_info,
     fit_res,
     file = paste0(out_folder, "Writeup15_", treatment, "-from-", day_early, "_fatepotential-rna.RData"))
