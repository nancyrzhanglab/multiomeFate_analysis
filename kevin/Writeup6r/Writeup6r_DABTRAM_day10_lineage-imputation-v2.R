...
for(i in 1:num_folds){
  ...
  save(cv_fit_list, date_of_run, session_info,
       file = paste0("../../../../out/kevin/Writeup6r/Writeup6r_", treatment, "_", day_early, "_lineage-imputation-tmp-v2.RData"))
}
...
save(date_of_run, session_info,
     ...
     tab_mat,
     file = paste0("../../../../out/kevin/Writeup6r/Writeup6r_", treatment, "_", day_early, "_lineage-imputation-v2.RData"))
