...
ggplot2::ggsave(filename = paste0("../../../../out/figures/Writeup5a/Writeup5a_tcca_RNA-geneActivity_laplacian.png"),
...
save(multiSVD_obj, all_data,
     ...
     file = "../../../../out/kevin/Writeup5a/Writeup5a_tcca_RNA-geneActivity.RData")
