...
cell_features <- cbind(scale(topic_mat))
...
for(i in 1:loocv_len){
  ...
  save(loocv_fit_list, date_of_run, session_info,
       file = paste0("../../../../out/kevin/Writeup6q/Writeup6q_", treatment, "_", day_early, "_lineage-imputation_onlyRNA-tmp.RData"))
}
...
save(date_of_run, session_info,
     ...
     loocv_fit_list, 
     tab_mat,
     file = paste0("../../../../out/kevin/Writeup6q/Writeup6q_", treatment, "_", day_early, "_lineage-imputation_onlyRNA.RData"))
