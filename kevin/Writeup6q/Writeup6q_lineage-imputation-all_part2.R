...
for(treatment in treatment_vec){
  ...
  for(ii in 1:2){
    ...
    png(paste0("../../../../out/figures/kevin/Writeup6q/Writeup6q_",
    ...
    save(cell_imputed_score,
         ...
         file = paste0("../../../../out/kevin/Writeup6q/Writeup6q_", treatment, "_", day_early, "_lineage-imputation_postprocess.RData"))
