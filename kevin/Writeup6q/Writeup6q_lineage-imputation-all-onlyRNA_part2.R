...
for(treatment in treatment_vec){
  ...
  for(ii in 1:2){
    ...
    load(paste0("../../../../out/kevin/Writeup6q/Writeup6q_", treatment, "_", day_early, "_lineage-imputation_onlyRNA.RData"))
    all_data2 <- all_data
    ...
    final_fit <- multiomeFate:::lineage_imputation(
      ...
      coefficient_initial_list = loocv_fit_list[[1]]$train_fit$fit_list[[which.min(test_mean)]]$coefficient_vec,
      lambda = lambda,
    ...
    png(paste0("../../../../out/figures/kevin/Writeup6q/Writeup6q_onlyRNA_",
    ...
    ggplot2::ggsave(filename = paste0("../../../../out/figures/kevin/Writeup6q/Writeup6q_onlyRNA_", treatment, "-", day_early, "_imputation-ridge_lineage-level.png"),
    ...
    save(cell_imputed_score,
         ...
         file = paste0("../../../../out/kevin/Writeup6q/Writeup6q_onlyRNA_", treatment, "_", day_early, "_lineage-imputation_postprocess.RData"))
