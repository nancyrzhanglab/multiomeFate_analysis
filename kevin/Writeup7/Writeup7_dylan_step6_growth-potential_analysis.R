...
for(treatment in treatment_vec){
  ...
  idx <- which(all_data$OG_condition %in% c("naive", treatment))
  keep_vec[idx] <- TRUE
  ...
  plot1 <- Seurat::DimPlot(all_data, reduction = "umap",
                           group.by = "OG_condition", pt.size = .3, label = T)
  plot1 <- plot1 + Seurat::NoLegend()
  ggplot2::ggsave(filename = paste0("../../../../out/figures/kevin/Writeup7/Writeup7_", treatment, "_umap.png"),
  ...
  load(paste0("~/project/Multiome_fate/out/kevin/Writeup7/Writeup7_dylan_step5_growth-potential_", treatment, ".RData"))
  all_data2 <- all_data
  ...
  png(paste0("~/project/Multiome_fate/out/figures/Writeup7/Writeup7_",
  ...
  ggplot2::ggsave(filename = paste0("~/project/Multiome_fate/out/figures/Writeup7/Writeup7_",
  ...
  ggplot2::ggsave(filename = paste0("~/project/Multiome_fate/out/figures/Writeup7/Writeup7_", treatment, 
  ...
  save(cell_features,
       ...
       file = paste0("~/project/Multiome_fate/out/kevin/Writeup7/Writeup7_dylan_step6_growth-potential_", treatment, "_postprocess.RData")
  )
