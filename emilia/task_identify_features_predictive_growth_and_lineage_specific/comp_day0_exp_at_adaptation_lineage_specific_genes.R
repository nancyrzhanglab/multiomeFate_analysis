...
# growth potential
load(paste0(dir, 'day10_DABTRAM/Writeup6k_DABTRAM_day10_lineage-imputation_stepdown_extract-growth-potential.RData'))
growth_potential_use <- day10_forDABTRAM_growth_potential
...
# day10 data
metadata_day10 <- read.csv(paste0(dir, 'day10_DABTRAM/day10_DABTRAM_meta.csv'), row.names = 1)
